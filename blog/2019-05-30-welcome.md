...
In one word, `integration`. AusTrakka aims to fill an important gap in the above projects, which is seamless integration of all the data needed to interpret the genomic information in order to reach at actionable public health responses, and one-click sharing of data across jurisdictions when required and appropriate.
...
To provide the seamless integration, data security and privacy are paramount requirements.